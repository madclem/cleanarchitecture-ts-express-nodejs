...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { Books } from './../src/infrastructure/api/controllers/book/book.controller';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/books',
            ...(fetchMiddlewares<RequestHandler>(Books)),
            ...(fetchMiddlewares<RequestHandler>(Books.prototype.list)),

            function Books_list(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/books/:id',
            ...(fetchMiddlewares<RequestHandler>(Books)),
            ...(fetchMiddlewares<RequestHandler>(Books.prototype.getById)),

            function Books_getById(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/books',
            ...(fetchMiddlewares<RequestHandler>(Books)),
            ...(fetchMiddlewares<RequestHandler>(Books.prototype.create)),

            function Books_create(request: any, response: any, next: any) {
            const args = {
        ...
        app.delete('/books/:id',
            ...(fetchMiddlewares<RequestHandler>(Books)),
            ...(fetchMiddlewares<RequestHandler>(Books.prototype.delete)),

            function Books_delete(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
